...
var WebSocket = /** @class */ (function (_super) {
    ...
    WebSocket.prototype._Handle_close = function (code, reason) {
        var event = new CloseEvent_1.CloseEvent("close", __assign(__assign({}, EVENT_INIT), { code: code, reason: reason }));
    ...
    WebSocket.prototype._Handle_message = function (message) {
        var event = new MessageEvent_1.MessageEvent("message", __assign(__assign({}, EVENT_INIT), { data: message.binaryData
                ? message.binaryData
                : message.utf8Data }));
        this.dispatchEvent(event);
    };
    ...
    WebSocket.prototype._Handle_error = function (error) {
        var event = new ErrorEvent_1.ErrorEvent("error", __assign(__assign({}, EVENT_INIT), { error: error, message: error.message }));
